...
const Info = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-5'>
            ...
            <InforCard img={marker} cardTitle="Visit our location" bgClass="bg-gradient-to-r from-accent to-primary" cardDetails="Brooklyn, NY 10036, United States" ></InforCard>
